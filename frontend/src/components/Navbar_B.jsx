...
const Navbar_B = () => {
    ...
    return(
        <nav className='relative z-10 flex items-center justify-between h-20 py-12 px-3 xl:px-8 drop-shadow-lg'>
            ...
            <button onClick={() => { setMenu(!menu) }}><img src="/assets/bars.png" alt="" className="xl:hidden fixed top-6 right-4"/></button>
            <div className='hidden xl:flex text-black montserrat-semibold text-xl gap-8'>
                ...
                <div className="relative group inline-block">
                  ...
                  transition-all duration-500 z-50">
                        <div className='flex gap-12 text-white bg-[#111827]/85 p-10 rounded-b-xl duration-500 -translate-y-4 group-hover:translate-y-[20px]'>
                            <div className='w-max'>
                                <p className='text-white/40 text-md montserrat-regular mb-3'>LEGALITAS</p>
                            ...
                            <div className='w-max'>
                                <p className='text-white/40 text-md montserrat-regular mb-3'>DIGITAL MARKETING</p>
                                <div className='flex flex-col gap-4'>
                            ...
                            <div className='w-max'>
                                <p className='text-white/40 text-md montserrat-regular mb-3'>LAYANAN</p>
                                <div className='flex flex-col gap-4'>
            ...
            {menu &&
                <div className='flex z-50'>
                    ...
                    <div className='fixed flex flex-col bg-[#111827] top-0 left-0 h-screen w-56 z-50'>
                        <div className='py-2 flex justify-center mb-5 pr-3'>
                        ...
                        <div className='flex flex-col text-2xl gap-4 text-white montserrat-bold pl-2'>
                            <div className='flex items-center gap-2 pl-1 py-1 hover:bg-black/15 rounded'>
                                <FontAwesomeIcon icon={faHouse} color='white' className='h-5' />
                                <a href="/" className="duration-300 text-base montserrat-semibold">Home</a>
                            </div>

                            <div className='flex items-center gap-2 pl-1 py-1 hover:bg-black/15 rounded'>
                                <FontAwesomeIcon icon={faGear} color='white' className='h-5' />
                            ...
                            <div className='flex items-center gap-2 pl-1 py-1 hover:bg-black/15 rounded'>
                                <FontAwesomeIcon icon={faTag} color='white' className='h-5' />
                                <a className="duration-300 text-base montserrat-semibold" onClick={() => {
                                    if (!dropdown2) {
                                        setDropdown2(true)
                                    } else if (dropdown2) {
                            ...
                            <div className='flex items-center gap-2 pl-1 py-1 hover:bg-black/15 rounded'>
                                <FontAwesomeIcon icon={faCircleInfo} color='white' className='h-5' />
                                <a href="/aboutUs" className="duration-300 text-base montserrat-semibold">About Us</a>
                            </div>

                            <div className='flex items-center gap-2 pl-1 py-1 hover:bg-black/15 rounded'>
                                <FontAwesomeIcon icon={faPhone} color='white' className='h-5' />
