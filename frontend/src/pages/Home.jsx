...
const Home = () => {
    ...
    return (
        <>
            {/* HERO SECTION */}
            <section className="relative h-screen bg-[url('/assets/HeroBG_M2.png')] xl:bg-[url('/assets/HeroBG_D.png')] xl:shadow-2xl bg-center">
                <Navbar />
                ...
                {/* SERVICE */}
                <div className='absolute bottom-5 xl:-bottom-36 left-1/2 -translate-x-1/2 bg-white px-6 py-5 shadow-2xl rounded-xl w-[90%] max-w-md xl:max-w-xl xl:w-[90%]'>   
                    <div className='text-center'>
                        <h1 className='montserrat-semibold text-[#000] text-4xl'>SERVICES</h1>
                    </div>  
                    <div className='flex gap-8 xl:gap-20 justify-center pt-4'>
                        <div className='bg-white rounded-lg shadow-1 w-max p-8 p-4 text-center'>
                            <div className='p-5 xl:p-6 shadow-xl rounded-full'>
                                <img src="https://placehold.co/60x60" alt="" className='xl:w-20'/>
                            </div>
            ...
            <section className='flex justify-center bg-white mt-20 xl:mt-56'>
                <div className='flex flex-col xl:flex-row gap-16'>
                    ...
                    <div className='flex flex-col gap-5 bg-white shadow-1 p-5 min-w-72 rounded-lg'>
                        <img src="https://placehold.co/100x100" alt="" />
                        <div className='text-center'>
                            <h1 className='montserrat-semibold text-5xl'>340+</h1>
                            <h1 className='montserrat-regular text-3xl'>Project</h1>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col gap-5 bg-white shadow-1 p-5 min-w-72 rounded-lg'>
                        <img src="https://placehold.co/100x100" alt="" />
                        <div className='text-center'>
                            <h1 className='montserrat-semibold text-5xl'>213+</h1>
                            <h1 className='montserrat-regular text-3xl'>Legalitas</h1>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col gap-5 bg-white shadow-1 p-5 min-w-72 rounded-lg'>
                        <img src="https://placehold.co/100x100" alt="" />
                        <div className='text-center'>
                            <h1 className='montserrat-semibold text-5xl'>4+</h1>
                            <h1 className='montserrat-regular text-3xl'>Digital Marketing</h1>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col gap-5 bg-white shadow-1 p-5 min-w-72 rounded-lg'>
                        <img src="https://placehold.co/100x100" alt="" />
                        <div className='text-center'>
                            <h1 className='montserrat-semibold text-5xl'>101%</h1>
                            <h1 className='montserrat-regular text-3xl'>Client Satisfaction</h1>
                        </div>
                    </div>
            ...
            <section className='mt-20'>
                ...
                <div className='flex flex-col xl:flex-row xl:justify-center items-center gap-16 mt-20'>
                    ...
                    <div className='border border-[#559EFF] w-72 rounded-lg shadow-1'>
                    ...
                    <div className='border border-[#3FDF72] w-72 rounded-lg shadow-1'>
                    ...
                    <div className='border border-[#FF6F00] w-72 rounded-lg shadow-1'>
            ...
            <section className="relative flex flex-col justify-center mt-20 xl:mt-0">
                <svg className='block w-full -mb-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FF6F00" fill-opacity="1" d="M0,192L40,170.7C80,149,160,107,240,117.3C320,128,400,192,480,224C560,256,640,256,720,261.3C800,267,880,277,960,256C1040,235,1120,181,1200,154.7C1280,128,1360,128,1400,128L1440,128L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
                <div className='text-white bg-[#FF6F00] w-full flex flex-col items-center py-5'>
                    ...
                    <div className='flex flex-col xl:flex-row-reverse'>
                        <div className='flex justify-center xl:mt-8 xl:w-1/4'>
                            <img src="/assets/kantor_JAB.jpeg" alt="" className='xl:hidden w-96 rounded-xl mt-8'/>
                            <img src="https://placehold.co/100x200" alt="" className='w-96 mt-8 hidden xl:block'/>
                        </div>
                        <div className='mt-8 xl:w-3/4 xl:px-48'>
                            ...
                            <div className='flex flex-col gap-10 mt-10'>
                                ...
                                <div className='flex items-center xl:flex-col-reverse xl:gap-3'>
                                    <div className='text-center'>
                                        <p className='montserrat-bold text-xl'>Visi Kami</p>
                                    ...
                                    <div className='mr-5'>
                                        <img src="https://placehold.co/100x100" alt="" className='rounded-full w-96 xl:w-48'/>
                                    </div>
                                </div>

                                <div className='flex flex-row-reverse items-center xl:flex-col-reverse'>
                                    <div className='text-center'>
                                        <p className='montserrat-bold text-xl'>Misi Kami</p>
                                        <p className='px-2 xl:hidden'>Menjadi mitra terpercaya dalam digitalisasi dan legalitas usaha di Indonesia, serta berkontribusi membangun ekosistem bisnis yang profesional, modern, dan bertanggung jawab.</p>
                                        <p className='hidden xl:block'>
                ...
                <svg className='block w-full -mt-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FF6F00" fill-opacity="1" d="M0,192L40,170.7C80,149,160,107,240,117.3C320,128,400,192,480,224C560,256,640,256,720,261.3C800,267,880,277,960,256C1040,235,1120,181,1200,154.7C1280,128,1360,128,1400,128L1440,128L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>
            </section>
            ...
            <section className='xl:flex xl:items-center mt-20'>
                <div className='w-full flex xl:flex-col justify-center xl:ml-[10%]'>
                    ...
                    <div className='text-[#FF6F00] pr-80 hidden xl:block'>
                    ...
                    <div className='text-[#FF6F00] pr-80 hidden xl:block mt-8'>
                ...
                <div className='bg-white shadow-1 p-5 mx-5 rounded-xl xl:mr-36'>
                    ...
                    <form action="" className='flex flex-col'>
                        <div className='flex gap-5 mb-5'>
                            <input type="text" placeholder='Nama Depan' className='rounded-md py-1 px-2 montserrat-semibold w-2/4 border border-[#FF6F00] bg-transparent'/>
                            <input type="text" placeholder='Nama Belakang' className='rounded-md py-1 px-2 montserrat-semibold w-2/4 border border-[#FF6F00] bg-transparent'/>
                        </div>
                        <div className='flex flex-col gap-5 mb-5'>
                            <input type="text" placeholder='Email Anda' className='rounded-md py-1 px-2 montserrat-semibold w-full border border-[#FF6F00] bg-transparent' />
                            <input type="text" placeholder='Nomor Telepon' className='rounded-md py-1 px-2 montserrat-semibold w-full border border-[#FF6F00] bg-transparent' />
                        </div>
                        <div className='flex mb-5'>
                            <textarea name="" id="" placeholder='Pesan Anda!' className='rounded-md py-1 px-2 montserrat-semibold w-full border border-[#FF6F00] bg-transparent'></textarea>
                        </div>
                        <div className='flex'>
                            <button className='bg-[#FF6F00] py-1 w-full text-white montserrat-bold text-2xl rounded-md'>Kirim!</button>
                        </div>
                    </form>
                </div>
            </section>
